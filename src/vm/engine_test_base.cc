...
INSTANTIATE_TEST_CASE_P(EngineFailQuery, EngineTest, testing::ValuesIn(InitCases("/cases/query/fail_query.yaml")));

INSTANTIATE_TEST_CASE_P(EngineTestFzTest, EngineTest, testing::ValuesIn(InitCases("/cases/query/fz_sql.yaml")));

// INSTANTIATE_TEST_CASE_P(
//     EngineTestFzTempTest, EngineTest,
//     testing::ValuesIn(InitCases("/cases/query/fz_temp.yaml")));

INSTANTIATE_TEST_CASE_P(EngineSimpleQuery, EngineTest, testing::ValuesIn(InitCases("/cases/query/simple_query.yaml")));
INSTANTIATE_TEST_CASE_P(EngineConstQuery, EngineTest, testing::ValuesIn(InitCases("/cases/query/const_query.yaml")));
INSTANTIATE_TEST_CASE_P(EngineUdfQuery, EngineTest, testing::ValuesIn(InitCases("/cases/query/udf_query.yaml")));
INSTANTIATE_TEST_CASE_P(EngineOperatorQuery, EngineTest,
                        testing::ValuesIn(InitCases("/cases/query/operator_query.yaml")));
INSTANTIATE_TEST_CASE_P(EngineUdafQuery, EngineTest, testing::ValuesIn(InitCases("/cases/query/udaf_query.yaml")));
...
INSTANTIATE_TEST_CASE_P(EngineWindowQuery, EngineTest, testing::ValuesIn(InitCases("/cases/query/window_query.yaml")));
...
INSTANTIATE_TEST_CASE_P(EngineTestWindowRowQuery, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/window/test_window_row.yaml")));

INSTANTIATE_TEST_CASE_P(EngineTestWindowRowsRangeQuery, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/window/test_window_row_range.yaml")));

INSTANTIATE_TEST_CASE_P(EngineTestWindowUnion, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/window/test_window_union.yaml")));
INSTANTIATE_TEST_CASE_P(EngineTestWindowMaxSize, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/window/test_maxsize.yaml")));
...
INSTANTIATE_TEST_CASE_P(EngineTestArithmetic, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/expression/test_arithmetic.yaml")));
INSTANTIATE_TEST_CASE_P(EngineTestCompare, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/expression/test_compare.yaml")));
INSTANTIATE_TEST_CASE_P(EngineTestCondition, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/expression/test_condition.yaml")));
INSTANTIATE_TEST_CASE_P(EngineTestLogic, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/expression/test_logic.yaml")));
INSTANTIATE_TEST_CASE_P(EngineTestType, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/expression/test_type.yaml")));

INSTANTIATE_TEST_CASE_P(EngineTestSubSelect, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/select/test_sub_select.yaml")));

INSTANTIATE_TEST_CASE_P(EngineTestUdfFunction, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/function/test_udf_function.yaml")));
INSTANTIATE_TEST_CASE_P(EngineTestUdafFunction, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/function/test_udaf_function.yaml")));
INSTANTIATE_TEST_CASE_P(EngineTestCalculateFunction, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/function/test_calculate.yaml")));
INSTANTIATE_TEST_CASE_P(EngineTestDateFunction, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/function/test_date.yaml")));
INSTANTIATE_TEST_CASE_P(EngineTestStringFunction, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/function/test_string.yaml")));

INSTANTIATE_TEST_CASE_P(EngineTestSelectSample, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/select/test_select_sample.yaml")));
INSTANTIATE_TEST_CASE_P(EngineTestWhere, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/select/test_where.yaml")));

INSTANTIATE_TEST_CASE_P(EngineTestFzFunction, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/test_feature_zero_function.yaml")));
...
INSTANTIATE_TEST_CASE_P(EngineTestClusterWindowRow, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/cluster/test_window_row.yaml")));
INSTANTIATE_TEST_CASE_P(EngineTestClusterWindowRowRange, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/cluster/test_window_row_range.yaml")));

INSTANTIATE_TEST_CASE_P(EngineTestWindowExcludeCurrentTime, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/test_window_exclude_current_time.yaml")));

INSTANTIATE_TEST_CASE_P(EngineTestIndexOptimized, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/test_index_optimized.yaml")));
...
INSTANTIATE_TEST_CASE_P(EngineTestSparkFQZ, EngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/spark/test_fqz_studio.yaml")));
// 单表-广告场景
...
INSTANTIATE_TEST_CASE_P(BatchRequestEngineTest, BatchRequestEngineTest,
                        testing::ValuesIn(InitCases("/cases/integration/v1/test_batch_request.yaml")));
}  // namespace vm
}  // namespace hybridse
