...
INSTANTIATE_TEST_CASE_P(BatchRequestTestWindowRowsRangeQuery, BatchRequestOptimizeTest,
...
void CheckOptimizePlan(const SqlCase& sql_case_org, const std::set<size_t> common_column_indices, bool unchanged) {
    ...
    if (boost::contains(sql_case.mode(), "request-unsupport") || boost::contains(sql_case.mode(), "rtidb-unsupport")) {
