...
ExprNode *NodeManager::MakeTimeFuncNode(const TimeUnit time_unit, ExprListNode *list_ptr) {
    ...
    FnDefNode *def_node = dynamic_cast<FnDefNode *>(MakeUnresolvedFnDefNode(fn_name));
...
ConstNode *NodeManager::MakeConstNodeINT16MAX() { return MakeConstNode(static_cast<int16_t>(INT16_MAX)); }
ConstNode *NodeManager::MakeConstNodeINT32MAX() { return MakeConstNode(static_cast<int32_t>(INT32_MAX)); }
ConstNode *NodeManager::MakeConstNodeINT64MAX() { return MakeConstNode(static_cast<int64_t>(INT64_MAX)); }
ConstNode *NodeManager::MakeConstNodeFLOATMAX() { return MakeConstNode(static_cast<float>(FLT_MAX)); }
ConstNode *NodeManager::MakeConstNodeDOUBLEMAX() { return MakeConstNode(static_cast<double>(DBL_MAX)); }
ConstNode *NodeManager::MakeConstNodeINT16MIN() { return MakeConstNode(static_cast<int16_t>(INT16_MIN)); }
ConstNode *NodeManager::MakeConstNodeINT32MIN() { return MakeConstNode(static_cast<int32_t>(INT32_MIN)); }
ConstNode *NodeManager::MakeConstNodeINT64MIN() { return MakeConstNode(static_cast<int64_t>(INT64_MIN)); }
ConstNode *NodeManager::MakeConstNodeFLOATMIN() { return MakeConstNode(static_cast<float>(FLT_MIN)); }
ConstNode *NodeManager::MakeConstNodeDOUBLEMIN() { return MakeConstNode(static_cast<double>(DBL_MIN)); }
...
FnIfElseBlock *NodeManager::MakeFnIfElseBlock(FnIfBlock *if_block, FnElseBlock *else_block) {
    ::hybridse::node::FnIfElseBlock *if_else_block = new ::hybridse::node::FnIfElseBlock(if_block, else_block);
...
BetweenExpr *NodeManager::MakeBetweenExpr(ExprNode *expr, ExprNode *left, ExprNode *right) {
